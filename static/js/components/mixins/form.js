        ...
        formatFieldError : function(field){
            if (this.state.fieldErrors !== undefined)
                if (field in this.state.fieldErrors)
                    return React.createElement("p", {className: "alert alert-warning"}, this.state.fieldErrors[field])
            return undefined;
        },

        formatErrorMessage : function(){
            if (this.state.errorMessage !== undefined)
                return React.createElement("p", {className: "alert alert-warning"}, this.state.errorMessage);
            return undefined;
        },
