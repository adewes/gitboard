                                    ...
                                    React.createElement("form", {className: "form-horizontal", 
                                     ...
                                     roleName: "form"}, 
                                        ...
                                        React.createElement("fieldset", null, 
                                            React.createElement("input", {type: "login", onChange: this.setLogin, id: "login", className: "form-control", placeholder: "Github Login", autofocus: true}), 
                                            this.formatFieldError('password'), 
                                            React.createElement("input", {type: "password", onChange: this.setPassword, id: "password", className: "form-control", placeholder: "Password"}), 
                                            this.formatFieldError('otp'), 
                                            React.createElement("input", {type: "login", onChange: this.setOtp, id: "otp", className: "form-control", placeholder: "One-Time-Password (if required)"}), 
                                            React.createElement("button", {id: "login-button", className: "btn btn-primary", type: "submit"}, React.createElement("span", {className: "text"}, "Log in"), " ", React.createElement("span", {className: "trigger"}))
                                        )
                                    )
                                )
                            )
